...
<main>
  ...
  <section class="section"><div class="container contact-grid">
    <form class="panel form-grid" method="post" action="mailto:aurorabagsupply@gmail.com">
    ...
    <aside class="panel"><h2>Business Contact</h2><p><strong>Address:</strong> Room 318, Building A, No.4 Helong 3rd Road, Baiyun District, Guangzhou</p><p><strong>Tel:</strong> (86)13500014739</p><p><strong>Email:</strong> aurorabagsupply@gmail.com</p><p><strong>Business:</strong> Bag hardware, leather materials, custom accessories</p><p><strong>Response Time:</strong> Within 24 hours</p><p>Please include product photos, drawings, size, finish, quantity and destination country when available.</p></aside>
  </div></section>
</main>
<?php get_footer(); ?>
