...
<main>
  <section class="hero hero-carousel" data-hero-carousel>
    <div class="hero-track" data-hero-track></div>
    <button class="hero-arrow hero-arrow--prev" type="button" data-hero-prev aria-label="Previous slide">Prev</button>
    <button class="hero-arrow hero-arrow--next" type="button" data-hero-next aria-label="Next slide">Next</button>
